# phase 1
## phase 1a: the first district lines
the following district lines open (in order):
- [[long island line]]
- [[east sheffield line]]
- [[east ivy line]]
- [[central sheffield line]]
- [[west sheffield line]]
- [[boa island line]] 
- [[pointer island line]]
...
- east coast line opens in stages with island and peninsula line
	- stage 1 (briarwood heights to autumn hills) opens with island line
...
- sunset bay loop opens in phases with progressive opening of other stages
	...
	- stage 2 (extension to borough 2) with opening of 3 borough 2 stations (farland fields)
	- stage 3 (completion) with opening of 4 borough 1 stations (woodlands and north coast)
...
it was then decided that the fairview line would take precedence over the remaining stages of the two city lines, and it was completed and opened first. it was around this time that the plan for phase 2 was released. the three borough 2 stations then opened as stage 2 of the sunset bay loop, and their district was named farland fields. the sunset bay loop was then completed with the three new stations in the new district woodlands. finally, north coast and south coast opened, finishing the east coast line.
